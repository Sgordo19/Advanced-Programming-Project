	...
	public void showMenu(Manager manager) {
		...
		while (loggedIn) {
			...
			case 2:
				...
				Report shipmentReport = reportService.generateShipmentReport(new Date(), new Date());
				shipmentReport.printReport();
				break;

			case 3:
				System.out.println("Generating delivery performance report...");
				Report perfReport = reportService.generateDeliveryPerformanceReport(new Date(), new Date());
