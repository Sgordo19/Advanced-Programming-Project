...
public class Schedulequeue {
	...
	public void displayQueue() {
		...
		while (temp != null) {
			...
			System.out.println("Package ID: " + pkg.getPackage_id() + " | Weight: " + pkg.getP_weight()
					+ " | Quantity: " + pkg.getP_quantity() + " | Destination: " + pkg.getDestination());
			temp = temp.getNextNode();
		}
	}

	/*
	 * public void displaySchedule() { if(Front == null) {
	 * System.out.println("The Vehicle has no schedule"); return; } Node temp =
	 * Front; int package_num = 1;
	 * 
	 * while (temp != null) { Package pkg = temp.getData();
	 ...
	 * System.out.println("--------------------"); package_num++; temp =
	 * temp.getNextNode(); } }
	 */
